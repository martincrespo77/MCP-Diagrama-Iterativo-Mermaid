...
class SpatialLayoutEngine:
    """Calculador de coordenadas virtuales (X, Y) y delimitadores de subgrafos."""

    def __init__(self, node_width: int = 280, node_height: int = 90, col_spacing: int = 460, row_spacing: int = 130):
    ...
    def compute_layout(self, nodes: Dict[str, Any], connections: List[Dict[str, Any]], subgraphs: Dict[str, Any]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
        # Organizar por subgrafo o capas
        ...
        for sub_id in subgraph_order:
            ...
            # Asignar coordenadas verticales a los nodos de esta columna
            curr_y = 70
            min_x = col_x
            min_y = curr_y - 30
            ...
            subgraph_zones.append({
                ...
                "x": min_x - 20,
                "y": min_y,
                "width": self.node_width + 40,
                "height": max_y - min_y
            })

            col_x += self.col_spacing

        # Nodos que no quedaron en ningún subgrafo
